...
function buildItems(pool: DomeImageItem[], seg: number): GridItem[] {
...
export default function DomeGallery({
  ...
  }, [enlargeTransitionMs, unlockScroll, onOpenChange]);
  ...
  const openItemFromElement = useCallback(
    (el: HTMLElement) => {
      ...
      // Clicking enlarged image directly also dismisses it smoothly
    ...
    [enlargeTransitionMs, lockScroll, openedImageHeight, openedImageWidth, segments, unlockScroll, onOpenChange, close]
  );
